...
class TestResConfigSettings(TransactionCase):
    ...
    def test_groups(self):
        ...
        self.assertFalse(
            self.admin_user._has_group("partner_statement_ferre.group_outstanding_statement")
        )
        self.assertTrue(
            self.admin_user._has_group("partner_statement_ferre.group_activity_statement")
        )
        res = (
