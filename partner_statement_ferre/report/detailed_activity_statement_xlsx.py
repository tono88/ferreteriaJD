...
from odoo.addons.report_xlsx_helper_ferre.report.report_xlsx_format import (  # type: ignore
    FORMATS,
)
...
class DetailedActivityStatementXslx(models.AbstractModel):
    ...
    def generate_xlsx_report(self, workbook, data, objects):
        ...
        report_model = self.env["report.partner_statement_ferre.detailed_activity_statement"]
