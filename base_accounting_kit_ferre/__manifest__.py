...
#############################################################################
{
    ...
    'assets': {
        'web.assets_backend': [
            'base_accounting_kit_ferre/static/src/scss/style.scss',
            'base_accounting_kit_ferre/static/src/scss/bank_rec_widget.css',
            'base_accounting_kit_ferre/static/src/js/bank_reconcile_form_list_widget.js',
            'base_accounting_kit_ferre/static/src/js/KanbanController.js',
            'base_accounting_kit_ferre/static/src/js/ListController.js',
            'base_accounting_kit_ferre/static/src/js/bank_reconcile_form_lines_widget.js',
            'base_accounting_kit_ferre/static/src/xml/bank_rec_widget.xml',
            'base_accounting_kit_ferre/static/src/xml/bank_reconcile_widget.xml',
        ]
    },
    'license': 'LGPL-3',
