...
################################################################################
{
	...
	'assets': {
		'web.assets_backend': [
			'pos_report_generator_ferre/static/src/js/PosReport.js',
			'pos_report_generator_ferre/static/src/xml/PosReport.xml',
			'pos_report_generator_ferre/static/src/css/pos_report.css',
		],
	},
