...
GT2_LAYOUTS = {
    "l10n_gt_check_printing2_ferre.check_top",
    "l10n_gt_check_printing2_ferre.check_middle",
    "l10n_gt_check_printing2_ferre.check_bottom",
}

GT2_VOUCHER_LAYOUTS = {
    "l10n_gt_check_printing2_voucher_ferre.check_top_voucher",
    "l10n_gt_check_printing2_voucher_ferre.check_middle_voucher",
    "l10n_gt_check_printing2_voucher_ferre.check_bottom_voucher",
}
...
class AccountPayment(models.Model):
    ...
    def do_print_checks(self):
        ...
        l10n_gt_check_printing2_ferre o el de Odoo base.
        """
        layouts = set(self.mapped("company_id.account_check_printing_layout"))
        if layouts and layouts.issubset(GT2_VOUCHER_LAYOUTS):
            action = self.env.ref("l10n_gt_check_printing2_voucher_ferre.action_report_check_gt2_voucher")
    ...
    def _get_checks_report_action(self):
        ...
        if self.company_id.account_check_printing_layout in GT2_VOUCHER_LAYOUTS:
            return self.env.ref("l10n_gt_check_printing2_voucher_ferre.action_report_check_gt2_voucher")
