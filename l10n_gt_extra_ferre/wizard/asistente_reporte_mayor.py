...
class AsistenteReporteMayor(models.TransientModel):
    ...
    def print_report(self):
        ...
        return self.env.ref('l10n_gt_extra_ferre.action_reporte_mayor').report_action(self, data=data)
    ...
    def print_report_excel(self):
        ...
        for w in self:
            ...
            res = self.env['report.l10n_gt_extra_ferre.reporte_mayor'].lineas(dict)
