...
class AsistenteReporteDiario(models.TransientModel):
    ...
    def print_report(self):
        ...
        return self.env.ref('l10n_gt_extra_ferre.action_reporte_diario').report_action(self, data=data)
    ...
    def print_report_excel(self):
        ...
        for w in self:
            ...
            res = self.env['report.l10n_gt_extra_ferre.reporte_diario'].lineas(dict)
